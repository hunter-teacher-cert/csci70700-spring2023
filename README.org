...
* Due Dates 
	...
	1. Work in Progress must be submitted to the GitHub repo in
         the correct location using specified filenames prior to the
	...
	3. If approved, the student will receive one extra week to
      ...
      4. This policy will not apply to any assignments due on the last
         ...
         grades are entered for an extension. In this case, the
         student can opt for an incomplete in the class for the extra
